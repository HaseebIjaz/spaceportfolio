...
const HeroContent = () => {
  return (
    ...
    >
      <div className="flex flex-col h-full w-full gap-5 m-auto text-start">
        <motion.div
        ...
        >
          I&apos;m a  Full Stack Developer with experience in building Web Applications . Checkout my projects and skills.
        </motion.p>
